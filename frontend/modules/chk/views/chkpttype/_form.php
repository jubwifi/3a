...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <?= $form->field($model, 'pttype')->hiddenInput(['maxlength' => true, 'value' => NULL])->label(FALSE); ?>
        <?= $form->field($model, 'name')->hiddenInput(['maxlength' => true, 'value' => NULL])->label(FALSE); ?>
