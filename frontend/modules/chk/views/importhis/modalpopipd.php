...
$('#close').click(function() {
                       window.location="./index.php?r=chk/importhis&vstdate="+'$vstdate'+'&type=1';  
                });
$('#close2').click(function() {
  ...
  $('#btnpttype').click(function() {
        ...
        $.ajax({
            type: 'POST', url: './index.php?r=chk/importhis/cpttypeipd&date1='+'$vstdate'+'&cid='+'$id', dataType: 'json',
                data: {
