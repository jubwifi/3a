...
<html lang="en">
    ...
    <body>
        ...
        <img src="../../assets/image-resources/poly-bg/poly-bg-2.jpg" class="login-img wow fadeIn" alt="">
                    ...
                    <div class="panel-layout wow bounceInDown">
                        <div class="panel-content pad0A bg-white">
                            <div class="meta-box meta-box-offset">
                                <img src="../../assets/image-resources/logoN.jpg" alt="" class="meta-image img-bordered img-circle" height="100" width="100">
                                <h3 class="meta-heading font-size-16">AAA</h3>
                                <h4 class="meta-subheading font-size-13 font-gray">Automatic Accounting Application</h4>
                            </div>
